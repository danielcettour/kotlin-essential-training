...
fun main() {
    ...
    val mutableMap1 = m1.toMutableMap() // convert to mutable map so elements can be added
    mutableMap1[88] = "epsilon" // adding an element to the map!!
    mutableMap1[89] = "omega" // adding an element to the map!!
